...
f2.add(settings, "f2_midu", -20, 50).step(1).name("密度")
...
f3.add(settings, "f3_midu", -20, 50).step(1).name("密度")
...
f4.add(settings, "f4_midu", -20, 50).step(1).name("密度")
f4.add(settings, "f4_rotateOpen", true).name("向心角度")

let f5 = gui.addFolder("菱形")
f5.addColor(settings, "f5_bgColor").name("背景色")
